...
{
	if (love::luax_loadbufferx(L, (const char *)love::nogame_lua, sizeof(love::nogame_lua), "=[love \"nogame.lua\"]") == 0)
		lua_call(L, 0, 1);
...
{
	if (love::luax_loadbufferx(L, arg_lua, sizeof(arg_lua), "=[love \"arg.lua\"]") == 0)
		lua_call(L, 0, 1);
...
{
	if (love::luax_loadbufferx(L, callbacks_lua, sizeof(callbacks_lua), "=[love \"callbacks.lua\"]") == 0)
		lua_call(L, 0, 1);
...
{
	if (love::luax_loadbufferx(L, boot_lua, sizeof(boot_lua), "=[love \"boot.lua\"]") == 0)
		lua_call(L, 0, 1);
