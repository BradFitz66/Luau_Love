...
function love.nogame()
	...
	")
	print("Loaded nogame data!")


	print("Starting 30log.lua")
	-- 30log.lua begins
	local function require_30log()
		print("Loading 30log.lua...")
		...
		_class = function(name, attr)
			...
			c.new, c.extend, c.__index, c.includes = instantiate, extend, c, function(self, mixin)
	...
	-- 30log.lua ends
	print("End of 30log.lua")

	print("Starting physics stuff setup")
